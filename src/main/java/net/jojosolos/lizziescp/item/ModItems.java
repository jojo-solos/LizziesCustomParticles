...
public class ModItems {
    public static final Item SELECTOR = registerItem("selector", new SelectorItem(new Item.Settings().maxCount(1)));
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, Identifier.of(LizziesCustomParticles.MODID, name), item);
    }
